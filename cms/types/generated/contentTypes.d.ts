...
export interface ApiAllProjectExperienceAllProjectExperience
  extends Struct.CollectionTypeSchema {
  collectionName: 'all_project_experiences';
  info: {
    description: '';
    displayName: 'AllProjectExperience';
    pluralName: 'all-project-experiences';
    singularName: 'all-project-experience';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    experience: Schema.Attribute.Component<'about-me.experience-block', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::all-project-experience.all-project-experience'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiNavigationBarNavigationBar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    NavigationBar: Schema.Attribute.Component<
...
export interface ApiProfilePersonalProfilePersonal
  extends Struct.SingleTypeSchema {
  collectionName: 'profile_personals';
  info: {
    description: '';
    displayName: 'profile-personal';
    pluralName: 'profile-personals';
    singularName: 'profile-personal';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::profile-personal.profile-personal'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
